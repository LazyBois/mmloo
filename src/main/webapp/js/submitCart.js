...
$(function(){
     ...
     */
        $('.editAddr').click(function () {
            ...
            alert($(this).parent().hasClass('editing'))
            var addrInfo = $(this).parent().parent().find('.addr').html().split(" ");
            var alias = $('.alias').find('span').html();
            $('#addrModal').find('#uname1').val($(this).parent().parent().find('.uname').html());
            $('#city').val(addrInfo[0] + '-' + addrInfo[1] + '-' + addrInfo[2]);
            $('#addr_info').val(addrInfo[3]);
    ...
    */
    $('#addAddr').click(function () {
        $('#addrModal').find('.modal-header').find('span').text('编辑地址11');
        $('#uname1').val('');
        $('#city').val('');
        $('#addr_info').val('');
        $('#mobilephone').val('');
